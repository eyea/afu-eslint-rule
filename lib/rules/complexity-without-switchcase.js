// const complexityRule = require('eslint/lib/rules/complexity');

// module.exports = Object.assign({}, complexityRule, {
//     create(context) {
//         const defaultRule = complexityRule.create(context);

//         return {
//             'SwitchCase': node => {
//                 // 自定义逻辑处理 switch case 语句
//                 console.log('Encountered a switch case.');
//             },
//             'FunctionDeclaration:exit': node => {
//                 // 在函数声明结束时执行默认的复杂度检查
//                 defaultRule['FunctionDeclaration:exit'](node);
//             }
//         };
//     }
// });
